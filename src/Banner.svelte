<script>
  ...
  <div class="bg-gradient-to-r from-black via-teal-900 to-black w-full m-0 pt-3 text-gray-300">
    ...
    <div class="flex justify-around p-2 md:justify-end text-lg">
      <button class="transition ease-linear duration-300 mx-2 bg-transparent hover:bg-white text-white hover:text-black font-bold py-2 px-4 rounded inline-flex items-center">
        ...
        <a style="text-decoration:none" href="mailto:mzmarshall1278@gmail.com">Email me</a>
      </button>
      ...
      <button class="transition ease-linear duration-300 mx-2 bg-transparent hover:bg-white text-white hover:text-black font-bold py-2 px-4 rounded inline-flex items-center">
        ...
        <a style="text-decoration:none" href="tel:+2348161864963">Call me</a>
      </button>
    </div>
    <!-- image -->
      ...
      <div class="md:mt-40 md:col-span-2 text-center">
        ...
        <div class="my-6">
          <button class="transition ease-linear duration-300 text-teal-900 bg-white hover:bg-transparent hover:text-white font-bold py-2 px-4 rounded-full" >
            <a style="text-decoration:none" href="https://drive.google.com/file/d/1uYocsi1_d42oY3i0nVg5oeXPCUhVNrCc/view?usp=sharing" target="_blank">CHECKOUT MY RESUME</a>
          </button>
        </div>
        </div>
    </div>
