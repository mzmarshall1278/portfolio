  ...
  <div class="bg-gradient-to-r from-black via-teal-900 to-black w-full m-0 pt-3 text-gray-300">
    ...
    <div class="grid md:grid-cols-3 gap-5 pr-5">
      ...
      <div class="md:mt-40 md:col-span-2 text-center">
        ...
        <div class="my-6">
          <button class="transition ease-linear duration-300 text-teal-900 bg-white hover:bg-transparent hover:text-white font-bold py-2 px-4 rounded-full" >CHECKOUT MY RESUME
          </button>
        </div>
        </div>
    </div>
